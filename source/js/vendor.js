...
(function (factory) {
  ...
  var NiceScrollClass = function (myopt, me) {
    ...
    this.init = function () {
      ...
      var _scrollyhidden = { 'overflowY': 'hidden', };
      ...
      if (!self.ispage || !cap.isieold) {
        ...
        cursor.css({
          ...
          'webkitBorderRadius': opt.cursorborderradius,
          'mozBorderRadius': opt.cursorborderradius,
          'borderRadius': opt.cursorborderradius,
        });
        ...
        if (cap.cantouch || self.istouchcapable || opt.emulatetouch || cap.hasmstouch) {
          ...
          self.ontouchstartCursor = function (e, hronly) {
            ...
            if (self.isiframe && !cap.hasmousecapture) {
              ...
              self.css(self.doc, { "pointerEvents": "none", });
            }
            return self.cancelEvent(e);
          };
        ...
        if (cap.hasw3ctouch) { //IE11+
          self.css((self.ispage) ? $("html") : self.win, { 'touchAction': 'none', });
          self.css(self.rail, {
            'touchAction': 'none',
          });
          ...
          self.css((self.ispage) ? $("html") : self.win, { 'msTouchAction': 'none', });
          self.css(self.rail, {
            'msTouchAction': 'none',
          });
          self.css(self.cursor, {
